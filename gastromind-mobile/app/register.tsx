  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          {/* Botón de regreso usando Expo Router */}
          <TouchableOpacity 
          ...
          <View style={styles.form}>
            ...
            <View style={[styles.inputWrapper, error ? styles.inputError : null]}>
              ...
              <TouchableOpacity onPress={() => setShowConfirmPassword(!showConfirmPassword)}>
                {showConfirmPassword ? <EyeOff size={20} color={COLORS.accent} /> : <Eye size={20} color={COLORS.text} opacity={0.4} />}
              </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  backButton: { position: 'absolute', top: 60, left: 20, zIndex: 10, padding: 10, backgroundColor: 'rgba(255,255,255,0.5)', borderRadius: 20 },
  ...
  errorText: { color: COLORS.error, fontSize: 13, textAlign: 'center', marginBottom: 15, marginTop: -5 },
  mainButton: { backgroundColor: COLORS.primary, height: 65, borderRadius: 20, justifyContent: 'center', alignItems: 'center', elevation: 4, shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.2, shadowRadius: 12, marginTop: 10 },
