...
export default function LoginScreen() {
  ...
  const handleLogin = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      // router.replace('/home'); // Así irías al Home sin poder volver atrás al login
    }, 2000);
  };
...
const styles = StyleSheet.create({
  ...
  circle1: { width: 300, height: 300, backgroundColor: COLORS.primary, top: -50, right: -100 },
  circle2: { width: 200, height: 200, backgroundColor: COLORS.accent, bottom: -50, left: -60 },
  circle3: { width: 150, height: 150, backgroundColor: COLORS.secondary, top: height * 0.4, left: -40 },
  ...
  sparkleTag: { position: 'absolute', top: -5, right: -5, backgroundColor: COLORS.accent, padding: 6, borderRadius: 12 },
  header: { alignItems: 'center', marginBottom: 40 },
  brandName: { fontSize: 40, fontWeight: '900', color: COLORS.text, letterSpacing: -1.5 },
  ...
  form: { width: '100%' },
  inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.white, height: 65, borderRadius: 20, paddingHorizontal: 20, marginBottom: 16, borderWidth: 1, borderColor: '#e8f5ed' },
  inputIcon: { marginRight: 15 },
  input: { flex: 1, fontSize: 16, color: COLORS.text, fontWeight: '600' },
  forgotPass: { alignSelf: 'flex-end', marginBottom: 30, paddingRight: 5 },
  forgotText: { color: COLORS.text, fontSize: 14, fontWeight: '500', opacity: 0.5 },
  mainButton: { backgroundColor: COLORS.primary, height: 65, borderRadius: 20, justifyContent: 'center', alignItems: 'center', elevation: 4, shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.2, shadowRadius: 12 },
  buttonText: { color: COLORS.white, fontSize: 18, fontWeight: '800' },
  footer: { flexDirection: 'row', justifyContent: 'center', marginTop: 40 },
  footerText: { fontSize: 15, color: COLORS.text, opacity: 0.6 },
  signUpText: { fontSize: 15, color: COLORS.accent, fontWeight: '800' },
});